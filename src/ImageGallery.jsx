...
import navigate from './snd/navigate.mp3';
    ...
    <>
      ...
      {activePage === "main" && (
        <div style={{ position: 'fixed', top: '-20px', left: 0, right: 0, bottom: 0, zIndex: 1000, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'flex-start', paddingTop: '60px', pointerEvents: 'auto', overflowY: 'auto', gap: '6px', }}>
          ...
          {/* logo */}
          <img src={showStartMenu ? (currentLogo === logo_r ? logo_unhighlight_r : logo_unhighlight) : currentLogo} alt="Logo" className={cls} style={{ maxWidth: '80%', maxHeight: '80%', objectFit: 'contain', pointerEvents: 'auto' }} />
          ...
          <div className={txtCls + (startBtnImg === start_r ? " ru-text" : "")} style={txSt}>
            {startBtnImg === start_r ? (
              <>16-летний русский человек, увлекающийся I.T. и зависимый от инкрементальных игр<br /><b>достижения:</b><br />топ 30к роблокс оббиист, гд хардэст - icup, gci - super mega loop 1, eut - for the worthy<br /><a href="https://docs.google.com/spreadsheets/d/1hNKy5fBAEspdHAdJAL8b2HZCkP_eO-6zkkWQ0sMLrt0/edit?usp=sharing" target="_blank" rel="noreferrer">мои прохождения в etoh</a></>
            ) : (
              <>16 year old russian guy, tech nerd and incremental game addict<br /><b>achievements:</b><br />top 30k roblox obbyist, gd hardest - icup, gci - super mega loop 1, eut - for the worthy<br /><a href="https://docs.google.com/spreadsheets/d/1hNKy5fBAEspdHAdJAL8b2HZCkP_eO-6zkkWQ0sMLrt0/edit?usp=sharing" target="_blank" rel="noreferrer">my etoh completions</a></>
            )}
          </div>
